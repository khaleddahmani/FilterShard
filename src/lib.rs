...
#[derive(Debug)]
pub struct FilterShardProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FilterShardProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FilterShard processing");
    
    let mut processor = FilterShardProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FilterShardProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FilterShardProcessor::new(false);
